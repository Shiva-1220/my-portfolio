    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 section-padding">
      <div className="max-w-3xl mx-auto text-center animate-fade-in">
        ...
        <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10 leading-relaxed">
          ...
          I blend aesthetics with functionality to create solutions that users love.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <Button
            onClick={scrollToWork}
            className="px-6 py-2.5 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl btn-premium"
