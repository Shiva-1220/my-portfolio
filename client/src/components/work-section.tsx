...
const projects = [
  ...
  },
  {
    ...
    description: "Data visualization platform for business intelligence and reporting. Transforms complex data sets into actionable insights through intuitive charts and real-time metrics.",
    ...
    role: "UI Designer",
    tools: ["Figma", "Sketch"],
    challenge: "Executives needed quick access to key metrics without drowning in data. The existing dashboard was cluttered and required technical knowledge to interpret.",
    solution: "Created a hierarchy of information with KPI cards at the top, trend charts in the middle, and detailed tables below. Used color coding for quick status recognition.",
    outcome: "Delivered a clean, scannable dashboard that surfaces critical insights at a glance while maintaining depth for detailed analysis."
  },
  {
    id: 4,
